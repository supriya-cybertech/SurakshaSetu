...
from AI.tailgating_logic import TailgatingDetector
...
def alert_handler(alert):
    ...
    print(f"🚨 ALERT: {alert.incident_type} - {alert.severity} severity")
...
# Test 4: Visitor OTP System
print("\nTest 4: Visitor OTP System Integration")
print("-" * 80)

visitor_id = "VISITOR_TEST_001"
otp = otp_system.generate_otp(visitor_id)
print(f"✅ Generated OTP for visitor: {otp}")

valid = otp_system.verify_otp(visitor_id, otp)
print(f"✅ OTP verification: {'Valid' if valid else 'Invalid'}")
